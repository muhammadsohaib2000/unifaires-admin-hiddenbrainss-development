...
const CountryFundingPosting = () => {
  ...
  const handleUpdatePricing = async (name: string) => {
    ...
    setLoading(true);
    await axiosInstance
      .put(`/funding-country-pricing/${discountId}`, {
        discount: editedText[name],
      })
      .then((res) => {
...
export default CountryFundingPosting;
