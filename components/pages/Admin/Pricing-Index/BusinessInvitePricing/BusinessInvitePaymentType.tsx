...
const BusinessInvitePaymentType = () => {
  ...
  const fetchPaymentTypes = async () => {
    try {
      const res = await axiosInstance.get("/invite-payment-type");
  ...
  const handleCreate = async () => {
    ...
    try {
      setLoading(true);
      const res = await axiosInstance.post("/invite-payment-type", {
        ...postData,
        currency: currency,
      });
      if (res.status) {
...
export default BusinessInvitePaymentType;
