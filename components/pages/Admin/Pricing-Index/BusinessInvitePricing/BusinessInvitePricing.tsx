...
const BusinessInvitePricings = () => {
  ...
  const handleUpdatePricing = async (id: any) => {
    ...
    setLoading(true);
    await axiosInstance
      .put(`/invite-business-pricing/${discountId}`, {
        discount: editedText[id],
      })
      .then((res) => {
...
export default BusinessInvitePricings;
