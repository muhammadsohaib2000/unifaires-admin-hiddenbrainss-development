...
const CountryCoursePosting = () => {
  ...
  const handleUpdatePricing = async (name: string) => {
    ...
    setLoading(true);
    await axiosInstance
      .put(`/course-country-pricing/${discountId}`, {
        discount: editedText[name],
      })
      .then((res) => {
...
export default CountryCoursePosting;
