...
const BusinessCoursePosting = () => {
  ...
  const handleUpdatePricing = async (id: any) => {
    ...
    setLoading(true);
    await axiosInstance
      .put(`/course-business-pricing/${discountId}`, {
        discount: editedText[id],
      })
      .then((res) => {
...
export default BusinessCoursePosting;
