...
const CountryAssociateInvite = () => {
  ...
  const handleSaveClick = async (name: string) => {
    ...
    await axiosInstance
      .post("/associate-country-pricing", {
        country: name,
  ...
  const handleUpdatePricing = async (name: string) => {
    ...
    setLoading(true);
    await axiosInstance
      .put(`/associate-country-pricing/${discountId}`, {
        discount: editedText[name],
      })
      .then((res) => {
...
export default CountryAssociateInvite;
