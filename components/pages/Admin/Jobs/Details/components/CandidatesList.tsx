...
const CandidatesList = ({
  ...
  const changeJobStatus = async (jobStatus: any) => {
    try {
      const res = await axiosInstance.put(`/enrol-job/status/${enrolId}`, {
        jobUserStatus: jobStatus,
      });
      if (res.status) {
  ...
  const intervieItems: MenuProps["items"] = [
    ...
    },
    {
      ...
      key: "unassign",
      onClick: () => changeJobStatus("pending"),
    },
    {
      label: (
        <IconText
      ...
      key: "accept",
      onClick: () => changeJobStatus("accepted"),
    },
    {
      label: (
        <IconText
      ...
      key: "reject",
      onClick: () => changeJobStatus("rejected"),
    },
  ];
  ...
  const items: MenuProps["items"] = [
    ...
    },
    {
      ...
      key: "interview",
      onClick: () => changeJobStatus("interviewing"),
    },
    {
      label: (
        <IconText
